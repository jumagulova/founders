...
export const metadata: Metadata = {
  title: 'Thank You | Founders for Kids',
  description: 'Thank you for downloading the Founders for Kids Starter Pack!',
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl p-10 md:p-14 border border-purple-100 text-center">
            ...
            <p className="text-gray-500 mb-10 max-w-md mx-auto leading-relaxed">
              Check your inbox in the next few minutes. If you don&apos;t see it, check your spam folder and mark us as safe so you never miss a thing.
            </p>

            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 mb-10 border border-purple-100">
              <p className="text-sm font-semibold text-purple-700 uppercase tracking-wide mb-2">While you wait</p>
              <p className="text-gray-600">
                Explore the stories behind the world&apos;s most iconic brands — written for kids ages 8–12.
              </p>
            </div>
